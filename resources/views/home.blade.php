<x-layout>
    <x-slot name="title">
        KU Info Village|HOME
    </x-slot>
    <link rel="stylesheet" href="{{ url('css/home.css') }}">
    <link rel="stylesheet" href="{{ url('css/home-res.css') }}">
        <!-- ローディング -->
        <div id="loading">
        ...
        <div class="about-container">
            <div class="about-logo">
                <img src="{{ asset('img/kulogo.png') }}" alt="">
            </div>
        ...
        <div class="service-container">
            <div class="ser-about">
                <div class="abo-inner">
                    <h2>―</h2>
                    <h3>About</h3>
                    <p class="abo-a">CLASSESページで授業情報の投稿・閲覧、MYPAGEでプロフィールの編集が可能ですので適宜ご利用ください。質問や投稿削除依頼は、お問い合わせページをご利用ください。</p>
            ...
            <div class="ser-dis">
                <div class="ser-dis-inner">
                    <div class="dis-area">
                        <h2>―</h2>
                        <h3>About Coding</h3>
                        <p class="dis-p">このサイトは、主にPHPというプログラミング言語を使用して制作しました。1人での開発かつ、初めて制作するWebアプリケーションになるので、不具合が起きたり、デザインに未熟な点が現れていると思いますが、お気づきの点がありましたらお問い合わせページより気軽にご意見をいただけると幸いです。</p>
        ...
        <div class="con-area">
            ...
            <div class="con-twi-link">
                <div class="twi-title">
                    ...
                    <a class="account" href="https://twitter.com/mixed25777" target="blank">Twitterアカウント</a>
                </div>
            </div>
        </div>
</x-layout>
